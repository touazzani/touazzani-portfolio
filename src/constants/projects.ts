...
export const projects = {
    ...
    athora : {
        ...
        slogan: "Service donnant accès à une liste de salles de sport partenaires via un abonnement unique.",
    ...
    cozyLife: {
        ...
        slogan: "Jeu multijoueur en 3D développé sous Unreal Engine, mêlant exploration, gestion et survie.",
    ...
    apple: {
        ...
        slogan : "Landing page interactive inspirée des présentations de produits haut de gamme."
    },
    gear: {
